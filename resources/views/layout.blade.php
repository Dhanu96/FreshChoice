...
<section>
                ...
                <div class="left-sidebar">
                    ...
                    <div class="price-range"><!--price-range-->
                        ...
                        <div class="well text-center">
                             ...
                             <b class="pull-left">LKR 0</b> <b class="pull-right">LKR 20000</b>
                        </div>
                    </div><!--/price-range-->
    ...
    <footer id="footer"><!--Footer-->
        ...
        <div class="footer-bottom">
            <div class="container">
                <div class="row">
                    <p class="pull-left">Copyright © 2020 FRESH-CHOICE All rights reserved.</p>
                    <p class="pull-right">Designed by <span><a target="_blank" >Esoft</a></span></p>
                </div>
            </div>
        </div>
