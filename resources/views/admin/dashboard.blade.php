		...
		<div class="widget span3 red" onTablet="span6" onDesktop="span3">
			...
			<div class="content">
				...
				<div class="browserStat big">
					<img src="{{URL::to('backend/img/browser-chrome-big.png')}}" alt="Chrome">
					<span>34%</span>
				</div>
				<div class="browserStat big">
					<img src="{{URL::to('backend/img/browser-firefox-big.png')}}" alt="Firefox">
					<span>34%</span>
				</div>
				<div class="browserStat">
					<img src="{{URL::to('backend/img/browser-ie.png')}}" alt="Internet Explorer">
					<span>34%</span>
				</div>
				<div class="browserStat">
					<img src="{{URL::to('backend/img/browser-safari.png')}}" alt="Safari">
					<span>34%</span>
				</div>
				<div class="browserStat">
					<img src="{{URL::to('backend/img/browser-opera.png')}}" alt="Opera">
					<span>34%</span>
				</div>	
