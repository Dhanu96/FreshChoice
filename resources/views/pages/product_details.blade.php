					...
					<div class="product-details"><!--product-details-->
						...
						<div class="col-sm-7">
							<div class="product-information"><!--/product-information-->
								<img src="{{URL::to('forntend/images/product-details/new.jpg')}}" class="newarrival" alt="" />
								<h2>{{$product_by_details->product_name}}</h2>
								<p>Color: {{$product_by_details->product_color}}</p>
								<img src="{{URL::to('forntend/images/product-details/rating.png')}}" alt="" />
								<span>
									<span>LKR {{$product_by_details->product_price}}</span>
